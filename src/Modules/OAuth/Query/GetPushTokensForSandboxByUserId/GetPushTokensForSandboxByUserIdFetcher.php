...
final class GetPushTokensForSandboxByUserIdFetcher
{
    ...
    /**
     * @return array{array {platform: string, token: string, voip_token: string, locale: string}}
     * @throws Exception
     */
    public function fetch(int $userId): array
    {
        ...
        /** @var array{array{push_token: string, voip_token: string, system_name: string, locale: string}} */
        ...
        /** @var array{array {platform: string, token: string, voip_token: string, locale: string}} $items */
        return $items;
    }
