...
final class GetPushTokensByUserIdFetcher
{
    ...
    /**
     * @return array{array {bundleId: string, platform: string, token: string, voip_token: string, locale: string}}
     * @throws Exception
     */
    public function fetch(int $userId): array
    {
        ...
        /** @var array{array{bundle_id: string, push_token: string, voip_token: string, system_name: string, locale: string}} */
        ...
        /** @var array{array {bundleId: string, platform: string, token: string, voip_token: string, locale: string}} $items */
        return $items;
    }
